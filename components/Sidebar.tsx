...
const ICONS = {
    ...
    PAYMENT: <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" /></svg>,
...
const NavItemsConfig: { [key in Role]: NavItem[] } = {
    ...
    ADMIN: [
        { path: '/admin-review', label: 'Review Budget', icon: ICONS.REVIEW },
        { path: '/procurement', label: 'Pengadaan', icon: ICONS.PROCUREMENT },
        { path: '/payment-tracking', label: 'Payment Tracking', icon: ICONS.PAYMENT },
